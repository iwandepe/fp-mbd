                ...
                <div class="form ml-4 mr-4">
                    <form method="POST" enctype="multipart/form-data" action="/customer/form">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="" id="contact_name">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="" id="contact_title">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" value="" id="region">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="" id="postal_code">
