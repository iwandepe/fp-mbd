                ...
                <div class="form ml-4 mr-4">
                    <form method="POST" enctype="multipart/form-data" action="/employee">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="" id="last_name" name="title_of_courtesy">
                        </div>
                        <div class="form-group">
                            <label for="birth_date" class="form-control-label">Birth Date</label>
                            <input class="form-control" type="date" value="" id="birth_date" name="birth_date">
                        </div>
                        <div class="form-group">
                            <label for="hire_date" class="form-control-label">Hire Date</label>
                            <input class="form-control" type="date" value="" id="hire_date" name="hire_date">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" value="" id="postal_code" name="postal_code">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" value="" id="home_phone" name="home_phone">
                        </div>
                        <div class="form-group">
                            <label for="extension" class="form-control-label">Extension</label>
                            <input class="form-control" type="text" value="" id="extension" name="extension">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="" id="notes" name="notes">
                        </div>
                        <div class="form-group">
                            <label for="reports_to" class="form-control-label">Reports_to</label>
                            <input class="form-control" type="number" value="" id="reports_to" name="reports_to">
                        </div>
                        <div class="form-group">
                            <label for="photo_path" class="form-control-label">Photo Path</label>
                            <input class="form-control" type="text" value="" id="photo_path" name="photo_path">
                        </div>
