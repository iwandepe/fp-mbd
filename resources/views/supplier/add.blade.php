        ...
        <div class="col">
            <div class="card">
                ...
                <div class="form ml-4 mr-4">
                    <div>{{$errors}}</div>
                    <form method="POST" enctype="multipart/form-data" action="/supplier">
                        @csrf
                        {{-- <div class="form-group">
                            <label for="supplier_id" class="form-control-label">Supplier id</label>
                            <input class="form-control" type="number" value="" id="supplier_id" name="supplier_id">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="" id="homepage" name="homepage">
